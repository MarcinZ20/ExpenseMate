  ...
  <section class="bg-transparent dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 text-center">
      <div class=" mb-8 lg:mb-16">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-purple-700 dark:text-white">Designed to tailor your needs</h2>
        <p class="text-gray-500 sm:text-xl dark:text-gray-400">Visualize your budget flow with tailored, easy-to-read graphs and analytics.</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
        <div class="p-2 flex flex-col items-center">
          <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-yellow-400 lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <h3 class="mb-2 text-xl text-yellow font-bold dark:text-white">AI Receipt Scanning</h3>
          <p class="text-gray-500 dark:text-gray-400">Snap a photo of your receipt and let AI transform it into organized expenses instantly.</p>
        </div>
        <div class="p-2 flex flex-col items-center">
          <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-yellow-400 lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <h3 class="mb-2 text-xl text-yellow font-bold dark:text-white">Smart Expense Categorization</h3>
          <p class="text-gray-500 dark:text-gray-400">Automatically categorize and filter your expenses for clear financial insights.</p>
        </div>
        <div class="p-2 flex flex-col items-center">
          <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-yellow lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <h3 class="mb-2 text-xl text-yellow font-bold dark:text-white">Personalized Budget Charts</h3>
          <p class="text-gray-500 dark:text-gray-400">Visualize your budget flow with tailored, easy-to-read graphs and analytics.</p>
        </div>
        <div class="p-2 flex flex-col items-center">
          <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-yellow lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <h3 class="mb-2 text-xl text-yellow font-bold dark:text-white">Alerts & Recommendations</h3>
          <p class="text-gray-500 dark:text-gray-400">Receive AI-powered alerts and tailored tips to optimize your spending and reach your goals.</p>
        </div>
        <div class="p-2 flex flex-col items-center">
          <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-yellow lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <h3 class="mb-2 text-xl text-yellow font-bold dark:text-white">Savings Goals Tracker</h3>
          <p class="text-gray-500 dark:text-gray-400">Set and track savings goals to stay motivated and achieve your financial dreams.</p>
        </div >
        <div class="p-2 flex flex-col items-center">
          <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-yellow lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <h3 class="mb-2 text-xl text-yellow font-bold dark:text-white">Slick & Intuitive Design</h3>
          <p class="text-gray-500 dark:text-gray-400">Effortless navigation with a clean and modern interface that makes budgeting a breeze.</p>
        </div>
      </div>
    </div>
  </section>

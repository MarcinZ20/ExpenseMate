...
<template>
  <footer class="p-4 bg-purple-800 md:p-8 lg:p-10 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl text-center">
      ...
      <ul class="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
        ...
        <li>
          <a href="#" class="mr-4 hover:underline md:mr-6 text-white">Premium</a>
        </li>
        <li>
          <a href="#" class="mr-4 hover:underline md:mr-6 text-white ">Campaigns</a>
        </li>
        <li>
          <a href="#" class="mr-4 hover:underline md:mr-6 text-white">Blog</a>
        </li>
        <li>
          <a href="#" class="mr-4 hover:underline md:mr-6 text-white">Affiliate Program</a>
        </li>
        <li>
      ...
      <span class="text-sm text-purple-200 sm:text-center dark:text-gray-400">© 2025 <a href="#" class="hover:underline">ExpenseMate™</a>. All Rights Reserved.</span>
    </div>
  </footer>
</template>
